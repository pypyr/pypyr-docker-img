...
$ docker run pypyr/pypyr-go-terra mypipelinename --logl 10

# run container /src/cpipelines/mypipelinename.yaml with INFO logging level.
$ docker run pypyr/pypyr-go-terra mypipelinename --logl 20
...
$ docker run -v ${PWD}:/src pypyr/pypyr-go-terra substitutions "key1=this is key1 in context,key2=pipe" --logl 10
```
